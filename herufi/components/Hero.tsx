...
export default function Hero({
  ...
  return (
    <section className="relative min-h-[88vh] flex items-center bg-cream overflow-hidden">
      ...
      <div className={`relative max-w-7xl mx-auto px-6 py-28 w-full ${centered && !hasImage ? 'text-center' : ''}`}>
        {hasImage ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-semibold text-charcoal leading-[1.08] tracking-tight mb-6">
                {headline}
              </h1>
              <p className="text-lg md:text-xl text-charcoal/55 leading-relaxed mb-10">
                {subtext}
              </p>
            ...
            <div className="relative rounded-2xl overflow-hidden aspect-[4/3] shadow-2xl">
              ...
              />
              {/* Subtle overlay */}
              <div className="absolute inset-0 bg-gradient-to-br from-forest/10 to-transparent" />
            </div>
          </div>
        ) : (
